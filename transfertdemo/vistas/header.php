...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>T</b>DM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>TRANSFER</b>DEMO</span>
    </a>
      ...
      <ul class="sidebar-menu" id="menu" data-widget="tree">
        ...
        <li>
              <a href="#">
                ...
                <small class="label pull-right bg-yellow">TRANSFER DEMO</small>
              </a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
